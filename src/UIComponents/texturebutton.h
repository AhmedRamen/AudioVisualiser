...
public:
	TextureButton(int x, int y, int w, int h, const std::string& spriteSheetPath) : Rectangle{ x,y,w,h, {0,255,0} }, spriteSheet(LoadTexture(spriteSheetPath.c_str(), renderer)), currentFrame(0) {
		buttonFrames[0] = { 0,0,w,h }; //Normal
		buttonFrames[1] = { w,0,w,h }; //Hovering
		buttonFrames[2] = { w * 2,0,w,h }; //Clicked
